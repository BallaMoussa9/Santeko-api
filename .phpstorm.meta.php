...
'fortify.features','l5-swagger.default','l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.routes.api','l5-swagger.documentations.default.paths.use_absolute_path',
...
'sanctum.token_prefix','sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','scribe.title',
'scribe.description','scribe.base_url','scribe.routes.0.match.prefixes','scribe.routes.0.match.domains','scribe.routes.0.include',
...
'scribe.openapi.overrides','scribe.openapi.generators','scribe.groups.default','scribe.groups.order','scribe.logo',
'scribe.last_updated','scribe.examples.faker_seed','scribe.examples.models_source','scribe.strategies.metadata','scribe.strategies.headers',
'scribe.strategies.headers.2.1.only','scribe.strategies.headers.2.1.except','scribe.strategies.headers.2.1.data.Content-Type','scribe.strategies.headers.2.1.data.Accept','scribe.strategies.urlParameters',
'scribe.strategies.queryParameters','scribe.strategies.bodyParameters','scribe.strategies.responses','scribe.strategies.responses.5.1.only','scribe.strategies.responses.5.1.except',
...
'scribe.strategies.responseFields','scribe.database_connections_to_transact','scribe.fractal.serializer','sentry.dsn','sentry.release',
...
'l5-swagger.default.api','scribe','l5-swagger.default.asset','l5-swagger.default.oauth2_callback','scribe.postman',
'scribe.openapi','login','login.store','logout','password.request',
...
'two-factor.qr-code','two-factor.secret-key','two-factor.recovery-codes','sanctum.csrf-cookie','telescope','storage.local',);
        registerArgumentsSet('views', 
'l5-swagger::index','scribe.index','vendor.l5-swagger.index','welcome','l5-swagger::index',
...
'scribe::components.badges.auth','scribe::components.badges.base','scribe::components.badges.http-method','scribe::components.field-details','scribe::components.nested-fields',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','scribe::scribe.0',);
